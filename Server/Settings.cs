...
namespace Server
{
    public static class Settings
    {
        ...
        public static readonly string EnvirPath = Path.Combine(".", "Envir"),
            ...
            PreviewsPath = Path.Combine(EnvirPath, "Previews"),
            HairPath = Path.Combine(EnvirPath, "Previews", "NPC", "Hair");
        ...
        //General
        public static string VersionPath = Path.Combine(".", "Mir1.Exe");
        public static bool CheckVersion = true;
        public static List<byte[]> VersionHashes;
        public static string GMPassword = "CarbonMir1.0";
        ...
        public static string BanIPsListFilename = "BannedIPs";
        ...
        public static int RestedPeriod = 60,
                          ...
                          RestedExpBonus = 5,
                          RestedMaxBonus = 24,
                          PalaceGuildMaxSize = 1000;

        public static string PalaceGuild = "PalaceGuild",
        ...
        {            
            ...
            PalaceGuild = Reader.ReadString("Game", "PalaceGuild", PalaceGuild);
            PalaceGuildMaxSize = Reader.ReadInt32("Game", "PalaceGuildMaxSize", PalaceGuildMaxSize);
            ...
            string MaleBodyPath = Path.Combine(EnvirPath, "Previews", "NPC", "Body", "Male");
            if (!Directory.Exists(MaleBodyPath))
                Directory.CreateDirectory(MaleBodyPath);
            string FemalePath = Path.Combine(EnvirPath, "Previews", "NPC", "Body", "Female");
            if (!Directory.Exists(FemalePath))
                Directory.CreateDirectory(FemalePath);
            string HairPath = Path.Combine(EnvirPath, "Previews", "NPC", "Hair");
            if (!Directory.Exists(HairPath))
                Directory.CreateDirectory(HairPath);
            string MaleHairPath = Path.Combine(EnvirPath, "Previews", "NPC", "Hair", "Male");
            if (!Directory.Exists(MaleHairPath))
                Directory.CreateDirectory(MaleHairPath);
            string FemaleHairPath = Path.Combine(EnvirPath, "Previews", "NPC", "Hair", "Female");
            if (!Directory.Exists(FemaleHairPath))
                Directory.CreateDirectory(FemaleHairPath);
        ...
        public static void Save()
        {
            ...
            Reader.Write("Game", "PalaceGuild", PalaceGuild);
            Reader.Write("Game", "PalaceGuildMaxSize", PalaceGuildMaxSize);
