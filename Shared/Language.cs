public class GameLanguage
{
    ...
    public static string LowLevel = "You are not a high enough level.",
                         ...
                         GameName = "Legend of Mir 1 Battle of the King - LOMCN",
    ...
    public static void LoadClientLanguage(string languageIniPath)
    {
        ...
        GameLanguage.ItemTypeMaterial = reader.ReadString("Language", "ItemTypeCraftingMaterial", GameLanguage.ItemTypeMaterial);
    ...
    public static void SaveClientLanguage(string languageIniPath)
    {
        ...
        reader.Write("Language", "ItemTypeCraftingMaterial", GameLanguage.ItemTypeMaterial);
